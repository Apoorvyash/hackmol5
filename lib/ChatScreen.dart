    ...
    if (userInput == 'Hi') {
      ...
      setState(() {
        ...
        messages.insert(0, {
          "data": 0,
          "message":
          "Sakha can help you in various ways. You can add emergency contacts, read safety articles, shake your device to send an SOS message with your location, record your surroundings silently, and find safe routes on the map, and also record audio automatically and video in emergency. If you need any help in accessing these features, I'm always here to help."
        });
      });
    }
    else {
